...
interface KarmaPrivateSaleVestingVaultInterface extends ethers.utils.Interface {
  functions: {
...
export class KarmaPrivateSaleVestingVault extends BaseContract {
  ...
  interface: KarmaPrivateSaleVestingVaultInterface;
