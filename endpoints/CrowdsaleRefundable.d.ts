...
interface CrowdsaleRefundableInterface extends ethers.utils.Interface {
  functions: {
...
export class CrowdsaleRefundable extends BaseContract {
  ...
  interface: CrowdsaleRefundableInterface;
